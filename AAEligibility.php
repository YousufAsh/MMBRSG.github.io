            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
             ...
             <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page" id="breadcrumbCurrent">Regulations & Bylaws</li>
                    </ol>
                  </nav>
              ...
              <div class="list-group">
                ...
                <a href="AAEligibility.php" class="list-group-item list-group-item-action active" id="main">Eligbility</a>
              ...
              <div class="col-8">
                <div class="tab-content" id="nav-tabContent">
                  ...
                  <div class="tab-pane fade show active content" role="tabpanel">
                      ...
                      <h1>Quod equidem non reprehendo;</h1>

                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magni enim aestimabat pecuniam non modo non contra leges, sed etiam legibus partam. Aliena dixit in physicis nec ea ipsa, quae tibi probarentur; Quae quo sunt excelsiores, eo dant clariora indicia naturae. Facillimum id quidem est, inquam. Duo Reges: constructio interrete. Ita, quem ad modum in senatu semper est aliquis, qui interpretem postulet, sic, isti nobis cum interprete audiendi sunt. Omnes, qui non sint sapientes, aeque miseros esse, sapientes omnes summe beatos, recte facta omnia aequalia, omnia peccata paria; Hanc in motu voluptatem -sic enim has suaves et quasi dulces voluptates appellat-interdum ita extenuat, ut M. Vitiosum est enim in dividendo partem in genere numerare. Age sane, inquam. </p>
                      ...
                      <pre>Praesertim cum in re publica princeps esse velles ad eamque
                      ...
                      <p>Graecum enim hunc versum nostis omnes-: Suavis laborum est praeteritorum memoria. An vero, inquit, quisquam potest probare, quod perceptfum, quod. <code>Bonum integritas corporis: misera debilitas.</code> In ipsa enim parum magna vis inest, ut quam optime se habere possit, si nulla cultura adhibeatur. Omnia contraria, quos etiam insanos esse vultis. Videmus in quodam volucrium genere non nulla indicia pietatis, cognitionem, memoriam, in multis etiam desideria videmus. Claudii libidini, qui tum erat summo ne imperio, dederetur. Quid, cum fictas fabulas, e quibus utilitas nulla elici potest, cum voluptate legimus? Quid ei reliquisti, nisi te, quoquo modo loqueretur, intellegere, quid diceret? Aliam vero vim voluptatis esse, aliam nihil dolendi, nisi valde pertinax fueris, concedas necesse est. </p>
