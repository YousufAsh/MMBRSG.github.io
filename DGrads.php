            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              ...
              <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item" ><a href="Graduates.html">Graduates</a></li>
                      <li class="breadcrumb-item active" aria-current="page" id="breadcrumbCurrent">Distinguished Graduates</li>
                    </ol>
                  </nav>
              ...
              <div class="list-group">
                <!-- Change active relative to current webpage -->
                <a href="Graduates.html" class="list-group-item list-group-item-action" >
                  Graduates
                </a>
                <a href="DGrads.html" class="list-group-item list-group-item-action active" id="main">Distinguished Graduates</a>
                <a href="Register.html" class="list-group-item list-group-item-action">Register</a>
