            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              ...
              <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page" id="breadcrumbCurrent">Contact Us</li>
                    </ol>
                  </nav>

<div class="card">
  <!-- Button trigger modal -->
  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="width:10%; margin:0 auto; margin-top:30px;">
      Contact Us
    </button>
...
<div class="contactContent">
  <div class="contactBox">
      <span class="contactHeader">Mohammed Bin Rashid School of Government</span><br>
  ...
  <div class="contactBox">
      <span class="contactHeader">Executive President Office</span><br>
      E-mail:epoffice@mbrsg.ac.ae<br>
      Tel: 971-4-3175-537<br>
      Fax: 971-4-3258-353<br>
    </div>
  <div class="contactBox">
      <span class="contactHeader">Degree Programs</span><br>
      Nawal Mohammed<br>
      E-mail:nawal.akram@mbrsg.ac.ae<br>
      Tel: 971-4-3175548
  </div>
  <div class="contactBox">
      <span class="contactHeader">Events</span><br>
      Priyanka Barua<br>
      E-mail: priyanka.barua@mbrsg.ac.ae<br>
      Tel: 971-4-3293290<br>
    </div>
  <div class="contactBox">
      <span class="contactHeader">Executive Education</span><br>
      Kaltham AlFalasi<br>
      E-mail:Kaltham.alfalasi@mbrsg.ac.ae ​<br>
      Tel: 971-4-3175531
    </div>
  <div class="contactBox">
  <span class="contactHeader">General Contacts</span><br>
      Tel: 971-4-329-3290<br>
      Fax: 971-4-329-3291
  </div>


</div>
<div id="large"><div id="mapContainer"></div></div>
</div>             
</div>
...
<script>
    ...
    function regular_map() {
        var var_location = new google.maps.LatLng(25.222360, 55.289126);
        ...
        var var_map = new google.maps.Map(document.getElementById("mapContainer"),
            var_mapoptions);
